            ...
            if(this.readyState == 4){
                if (this.status == 200) {
                    ...
                    for(var i = 0; i < response["projects"].length; i++){
                        ...
                        content += "<a href='"+corr_base+"share/?type=project&id="+project["project"]["id"]+"' target='_blank' class='btn-floating activator btn-move-up waves-effect waves-light darken-2 right tooltipped' data-position='bottom' data-delay='50' data-tooltip='share'><i class='mdi-social-share'></i></a>";
            ...
            if(this.readyState == 4){
                if (this.status == 200) {
                    ...
                    for(var i = 0; i < response["users"].length; i++){
                        ...
                        content += "<a href='"+corr_base+"share/?type=user&id="+account["id"]+"' target='_blank' class='btn-floating activator btn-move-up waves-effect waves-light darken-2 right tooltipped' data-position='bottom' data-delay='50' data-tooltip='share'><i class='mdi-social-share'></i></a>";
            ...
            if(this.readyState == 4){
                if (this.status == 200) {
                    ...
                    for(var i = 0; i < response["content"]["apps"].length; i++){
                        ...
                        content += "<a href='"+corr_base+"share/?type=app&id="+app["id"]+"' target='_blank' class='btn-floating activator btn-move-up waves-effect waves-light darken-2 right tooltipped' data-position='bottom' data-delay='50' data-tooltip='share'><i class='mdi-social-share'></i></a>";
            ...
            if(this.readyState == 4){
                if (this.status == 200) {
                    ...
                    for(var i = 0; i < response["records"].length; i++){
                        ...
                        content += "<a href='"+corr_base+"share/?type=record&id="+record["head"]["id"]+"' target='_blank' class='btn-floating activator btn-move-up waves-effect waves-light darken-2 right tooltipped' data-position='bottom' data-delay='50' data-tooltip='share'><i class='mdi-social-share'></i></a>";
            ...
            if(this.readyState == 4){
                if (this.status == 200) {
                    ...
                    for(var i = 0; i < response["number"]; i++){
                        ...
                        content += "<a href='"+corr_base+"share/?type=diff&id="+diff["id"]+"' target='_blank' class='btn-floating activator btn-move-up waves-effect waves-light darken-2 right tooltipped' data-position='bottom' data-delay='50' data-tooltip='share'><i class='mdi-social-share'></i></a>";
            ...
            if(this.readyState == 4){
                if (this.status == 200) {
                    ...
                    for(var i = 0; i < response["envs"].length; i++){
                        ...
                        content += "<a href='"+corr_base+"share/?type=env&id="+env["id"]+"' target='_blank' class='btn-floating activator btn-move-up waves-effect waves-light darken-2 right tooltipped' data-position='bottom' data-delay='50' data-tooltip='share'><i class='mdi-social-share'></i></a>";
