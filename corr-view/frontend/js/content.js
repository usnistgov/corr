            ...
            if ((xmlhttp.status >= 200 && xmlhttp.status <= 300) || xmlhttp.status == 304) {
                if(xmlhttp.responseText != ""){
                    ...
                    for(var i = 0; i < response["projects"].length; i++){
                        ...
                        if(accessible){
                            content += "<div class='row margin'><div class='input-field col s12'><div class='switch'><label><i class='mdi-action-lock-open prefix cyan-text text-darken-2'></i><input id='project-access-"+project["project"]["id"]+"' onclick='projectAccess(\""+project["project"]["id"]+"\");' type='checkbox' checked><span class='lever'></span></label></div></div></div>";
                        }else{
                            content += "<div class='row margin'><div class='input-field col s12'><div class='switch'><label><i class='mdi-action-lock-open prefix cyan-text text-darken-2'></i><input id='project-access-"+project["project"]["id"]+"' onclick='projectAccess(\""+project["project"]["id"]+"\");' type='checkbox'><span class='lever'></span></label></div></div></div>";
                        }
            ...
            if ((xmlhttp.status >= 200 && xmlhttp.status <= 300) || xmlhttp.status == 304) {
                if(xmlhttp.responseText == ""){
                    ...
                    for(var i = 0; i < response["records"].length; i++){
                        ...
                        if(accessible){
                            content += "<div class='row margin'><div class='input-field col s12'><div class='switch'><label><i class='mdi-action-lock-open prefix cyan-text text-darken-2'></i><input id='record-access-"+record["head"]["id"]+"' onclick='recordAccess(\""+record["head"]["id"]+"\");' type='checkbox' checked><span class='lever'></span></label></div></div></div>";
                        }else{
                            content += "<div class='row margin'><div class='input-field col s12'><div class='switch'><label><i class='mdi-action-lock-open prefix cyan-text text-darken-2'></i><input id='record-access-"+record["head"]["id"]+"' onclick='recordAccess(\""+record["head"]["id"]+"\");' type='checkbox'><span class='lever'></span></label></div></div></div>";
                        }
