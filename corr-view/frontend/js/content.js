            ...
            if ((xmlhttp.status >= 200 && xmlhttp.status <= 300) || xmlhttp.status == 304) {
                if(xmlhttp.responseText != ""){
                    ...
                    for(var i = 0; i < response["projects"].length; i++){
                        ...
                        content += "<p><i class='mdi-device-access-alarm cyan-text text-darken-2'></i> "+project["project"]["duration"].split(",")[0]+"</p>";
            ...
            if ((xmlhttp.status >= 200 && xmlhttp.status <= 300) || xmlhttp.status == 304) {
                if(xmlhttp.responseText != ""){
                    ...
                    for(var i = 0; i < response["content"]["apps"].length; i++){
                        ...
                        content += "<div class='card-action center-align'>";
                        content += "<a onclick='Materialize.toast(\"<span>Application users view not implemented yet!</span>\", 3000);' class='valign left tooltipped' data-position='bottom' data-delay='50' data-tooltip='users'><i class='mdi-social-group-add cyan-text text-darken-2'></i> <span class='users badge'>"+app["users"]+"</span></a>";
            ...
            if ((xmlhttp.status >= 200 && xmlhttp.status <= 300) || xmlhttp.status == 304) {
                if(xmlhttp.responseText == ""){
                    ...
                    for(var i = 0; i < response["records"].length; i++){
                        ...
                        content += "<p><i class='mdi-device-access-alarm cyan-text text-darken-2'></i> "+record["head"]["duration"].split(",")[0]+"</p>";
            ...
            if ((xmlhttp.status >= 200 && xmlhttp.status <= 300) || xmlhttp.status == 304) {
                if(xmlhttp.responseText == ""){
                    ...
                    for(var i = 0; i < response["envs"].length; i++){
                        ...
                        content += "<a onclick='Materialize.toast(\"<span>Env resources view not implemented yet!</span>\", 3000);' class='valign left'><i class='mdi-file-cloud-download cyan-text text-darken-2'></i><span class='from badge'>"+env["resources"]+"</span></a>";
                        content += "<a onclick='Materialize.toast(\"<span>Env comments view not implemented yet!</span>\", 3000);' class='valign right'><i class='mdi-editor-insert-comment cyan-text text-darken-2'></i> <span class='comments badge'>"+env["comments"]+"</span></a>";
                        content += "<a onclick='Materialize.toast(\"<span>Env bundle view not implemented yet!</span>\", 3000);' class='valign'><i class='mdi-editor-insert-drive-file cyan-text text-darken-2'></i><span class='to badge'>"+env["bundle"].substring(0,4)+"..."+env["bundle"].substring(19,23)+"</span></a>";
