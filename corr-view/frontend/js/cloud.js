                ...
                if(this.readyState == 4){
                    if (this.status == 200) {
                        ...
                        if(user_block_check == undefined || user_block_check == null){
                            ...
                            content += "<div class='row margin tooltipped' data-position='bottom' data-delay='50' data-tooltip='tags'><div class='input-field col s12'><i class='mdi-action-assessment prefix cyan-text text-darken-2'></i><input readonly placeholder='x G' id='user-usage-"+account["id"]+"' type='text' value='"+account["usage"]+"%'></div></div>";
                        content += "<div class='row margin tooltipped' data-position='bottom' data-delay='50' data-tooltip='tags'><div class='input-field col s12'><i class='mdi-notification-disc-full prefix cyan-text text-darken-2'></i><input readonly placeholder='x G' id='user-quota-"+account["id"]+"' type='text' value='"+account["max-quota"]+"GB'></div></div>";
