var renderer = {
    user: function(object, ownership, session){
        ...
        content += "<div class='row margin tooltipped' data-position='bottom' data-delay='50' data-tooltip='goals'><div class='input-field col s12'><i class='mdi-action-subject prefix cyan-text text-darken-2'></i><input readonly id='user-about-"+object["id"]+"' type='text' value='"+object["about"]+"'></div></div>";
    ...
    application: function(object, ownership, session){
        ...
        // content += "<a href='./?session="+session+"&view=records&project="+object["id"]+"' class='btn-floating activator btn-move-up waves-effect waves-light darken-2 right "+disable_view+"'><i class='mdi-action-visibility'></i></a>";
        content += "<p class='grey-text ultra-small'><i class='mdi-device-access-time cyan-text text-darken-2'></i> "+object["created"]+"</p>";
        content += "<div class='row margin tooltipped' data-position='bottom' data-delay='50' data-tooltip='tags'><div class='input-field col s12'><i class='mdi-action-turned-in prefix cyan-text text-darken-2'></i><input readonly id='app-name-"+object["id"]+"' type='text' value='"+object["name"]+"'></div></div>";
        ...
        // content += "<p><i class='mdi-action-description cyan-text text-darken-2'></i> "+object["description"]+"</p>";
        content += "<div class='row margin tooltipped' data-position='bottom' data-delay='50' data-tooltip='goals'><div class='input-field col s12'><i class='mdi-action-subject prefix cyan-text text-darken-2'></i><textarea readonly class='materialize-textarea' id='app-about-"+object["id"]+"' type='text' value='"+object["about"]+"'>"+object["about"]+"</textarea></div></div>";
        // content += "<p><i class='mdi-action-subject cyan-text text-darken-2'></i> "+object["goals"]+"</p>";
        content += "<div class='card-action center-align'>";
        content += "onclick='Materialize.toast(\"<span>Project diffs view not implemented yet!</span>\", 3000);' class='valign left tooltipped' data-position='bottom' data-delay='50' data-tooltip='users'><i class='mdi-social-group-add cyan-text text-darken-2'></i> <span class='users badge'>"+object["users"]+"</span></a>";
    ...
    project: function(object, ownership, session){
        ...
        // content += "<p><i class='mdi-action-description cyan-text text-darken-2'></i> "+object["description"]+"</p>";
        content += "<div class='row margin tooltipped' data-position='bottom' data-delay='50' data-tooltip='goals'><div class='input-field col s12'><i class='mdi-action-subject prefix cyan-text text-darken-2'></i><input readonly id='project-goals-"+object["id"]+"' type='text' value='"+object["goals"]+"'></div></div>";
        // content += "<p><i class='mdi-action-subject cyan-text text-darken-2'></i> "+object["goals"]+"</p>";
        content += "<div class='card-action center-align'>";
    ...
    record: function(object, ownership, session){
        ...
        content += "<a onclick='Materialize.toast(\"<span>Application share not implemented yet!</span>\", 3000);' class='btn-floating activator btn-move-up waves-effect waves-light darken-2 right'><i class='mdi-social-share tooltipped' data-position='bottom' data-delay='50' data-tooltip='share'></i></a>";
        content += "<a onclick='customSearch(\"project\",\""+object["project"]+" "+object["project-name"]+"\");' class='btn-floating activator btn-move-up waves-effect waves-light darken-2 right'><i class='mdi-file-folder tooltipped' data-position='bottom' data-delay='50' data-tooltip='"+object["head"]["project-name"]+"'></i></a>";
        ...
        content += "<div class='row margin tooltipped' data-position='bottom' data-delay='50' data-tooltip='status'><div class='input-field col s12'><i class='mdi-action-subject prefix cyan-text text-darken-2'></i><input readonly id='record-status-"+object["head"]["id"]+"' type='text' value='This record status is: "+object["head"]["status"]+".'></div></div>";
