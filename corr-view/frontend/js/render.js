var renderer = {
    user: function(object, ownership, session){
        ...
        content += "<div class='row margin tooltipped' data-position='bottom' data-delay='50' data-tooltip='goals'><div class='input-field col s12'><i class='mdi-action-subject prefix cyan-text text-darken-2'></i><input readonly class='materialize-textarea' id='user-about-"+object["id"]+"' type='text' value='"+object["about"]+"'></div></div>";
    ...
    project: function(object, ownership, session){
        ...
        // content += "<p><i class='mdi-action-description cyan-text text-darken-2'></i> "+object["description"]+"</p>";
        content += "<div class='row margin tooltipped' data-position='bottom' data-delay='50' data-tooltip='goals'><div class='input-field col s12'><i class='mdi-action-subject prefix cyan-text text-darken-2'></i><input readonly class='materialize-textarea' id='project-goals-"+object["id"]+"' type='text' value='"+object["goals"]+"'></div></div>";
        // content += "<p><i class='mdi-action-subject cyan-text text-darken-2'></i> "+object["goals"]+"</p>";
        content += "<div class='card-action center-align'>";
    ...
    record: function(object, ownership, session){
        ...
        content += "<div class='row margin tooltipped' data-position='bottom' data-delay='50' data-tooltip='status'><div class='input-field col s12'><i class='mdi-action-subject prefix cyan-text text-darken-2'></i><input readonly class='materialize-textarea' id='record-status-"+object["head"]["id"]+"' type='text' value='This record status is: "+object["head"]["status"]+".'></div></div>";
