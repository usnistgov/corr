...
html_theme_options = {
    'navbar_title': "*",
    'navbar_links': [
        ("Database", "rst/corr-db/README.html", True),
...
texinfo_documents = [
    ('index', 'corr', u'CoRR Documentation',
     u'Faical Yannick P. Congo', 'corr', 'Materials Knowledge Systems in Python',
     'Miscellaneous'),
]
